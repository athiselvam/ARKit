...
class Gesture {
	...
	init(_ touches: Set<UITouch>, _ sceneView: ARSCNView, _ virtualObject: VirtualObject) {
        ...
        greenMaterial.diffuse.contents = UIImage(named: "Models.scnassets/texture.png")
        greenMaterial.locksAmbientWithDiffuse = true;
        
        let redMaterial = SCNMaterial()
        redMaterial.diffuse.contents = UIImage(named: "Models.scnassets/texture1.jpg")
        redMaterial.locksAmbientWithDiffuse = true;
        
        
        let blueMaterial  = SCNMaterial()
        blueMaterial.diffuse.contents = UIImage(named: "Models.scnassets/texture2.png")
        blueMaterial.locksAmbientWithDiffuse = true;
        
        
        let yellowMaterial = SCNMaterial()
        yellowMaterial.diffuse.contents = UIImage(named: "Models.scnassets/Texture3.png")
        yellowMaterial.locksAmbientWithDiffuse = true;
        
        materialArray.append(greenMaterial)
        materialArray.append(redMaterial)
        materialArray.append(blueMaterial)
        materialArray.append(yellowMaterial)
	...
	override init(_ touches: Set<UITouch>, _ sceneView: ARSCNView, _ virtualObject: VirtualObject) {
		...
		for result in results {
			if VirtualObject.isNodePartOfVirtualObject(result.node) {
               ...
               // let nodeArray = result.node.childNodes
                
                
                var dice1: Int = 0
                
                dice1 = Int(arc4random_uniform(4))
               // print(result.node.childNode(withName: <#T##String#>, recursively: <#T##Bool#>))
               // print(materialCount)
               // print(materialArray[materialCount])
               /* for childNode in nodeArray {
                    //print(childNode.childNode(withName: "Virtual object root node", recursively: true))
                    childNode.childNode(withName: "Virtual object root node", recursively: true)?.geometry?.materials=[materialArray[dice1],materialArray[dice1],materialArray[dice1],materialArray[dice1]]
                    //childNode.geometry?.materials = [materialArray[dice1],materialArray[dice1],materialArray[dice1],materialArray[dice1]]
                    
                }*/
                result.node.geometry?.materials = [materialArray[dice1],materialArray[dice1],materialArray[dice1],materialArray[dice1]]
